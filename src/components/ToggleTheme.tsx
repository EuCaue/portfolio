...
export default function ToggleTheme() {
  ...
  const checkTheme = useCallback((): void => {
    const isDarkTheme = theme === 'mytheme';
    if (isDarkTheme) {
      $darkSVG.current?.classList.remove('swap-off');
      $darkSVG.current?.classList.add('swap-on');
      $lightSVG.current?.classList.add('swap-off');
      $lightSVG.current?.classList.remove('swap-on');
    } else {
      $darkSVG.current?.classList.add('swap-off');
      $darkSVG.current?.classList.remove('swap-on');

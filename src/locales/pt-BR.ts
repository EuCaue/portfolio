...
export const ptBR: Record<TranslationKeys, string> = {
  ...
  "intro.description":
    "Desenvolvedor de Software apaixonado por criar soluções digitais completas, desde aplicações web e mobile até integrações nativas de sistema.",
  ...
  "about.paragraph1":
    "Sou um desenvolvedor de software que gosta de transitar por diferentes camadas da tecnologia. Minha experiência vai desde a criação de interfaces modernas e responsivas para a web e mobile (utilizando ecossistemas como React, Next.js e React Native), até o desenvolvimento de aplicações desktop nativas e extensões integradas para Linux/GNOME utilizando Python e JavaScript.",
  "about.paragraph2":
    "Acredito na tecnologia como uma ferramenta para resolver problemas reais de forma simples e eficiente. Busco sempre combinar rigor técnico, boas práticas de design e automação inteligente no meu dia a dia de desenvolvimento para criar experiências que sejam robustas por trás e fluidas para o usuário.",
  ...
  "projects.feedPet.description":
    "Um aplicativo web simples desenvolvido com Next.js and shadcn/ui para ajudar os usuários a acompanhar os horários de alimentação dos pets. Criado para evitar confusões em casa e garantir que todos os pets sejam alimentados na hora certa, com uma interface limpa e intuitiva.",
  ...
  "contact.subtitle":
    "Tem um projeto em mente ou apenas quer dizer olá? Sinta-se à voltar para entrar em contato!",
